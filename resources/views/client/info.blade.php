...
@section('content')
            <div class="content">
              <h1>Hi <?php echo $client['fname'].' '.$client['mname'];?></h1>
              <table width='480'>
                  ...
                  <tr><td class="right">Кол-во поев: </td><td><i class="fa fa-rub"></i><i id="pif-balance"><?php echo $products[0]['balance'];?></i></td>
                    <td>
              ...
              <svg width="100%" height="160">
                ...
                <text id="pif-balance-text" x="50%" y="84" fill="white" text-anchor="middle" style="font-weight:bold;"><?php echo $products[0]['balance'].' '.$products[0]['currency'];?></text>
